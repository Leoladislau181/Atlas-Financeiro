...
export function WelcomeWizard({ user, vehicles, categorias, refetch, isOpen, onComplete }: WelcomeWizardProps) {
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    ...
                    <Input 
                      ...
                      className="h-14 pl-12 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border-gray-100 dark:border-gray-800 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all text-lg font-bold"
                      required
                      autoFocus
                    />
                  </div>
